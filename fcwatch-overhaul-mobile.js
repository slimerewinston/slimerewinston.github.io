...
// Built: 2026-03-09T16:55:23.686Z
// =====================================================
(function() {
    'use strict';
...
(function __fcwGyroInspect() {
    ...
    // --- Request iOS 13+ Gyro Permission ---
    function requestGyroPermission() {
        if (typeof DeviceOrientationEvent !== 'undefined' &&
            ...
            DeviceOrientationEvent.requestPermission()
                ...
                .catch(function (err) {
                    console.error('[FCW Gyro] Permission error:', err);
                });
        } else {
    ...
    function onTouchEnd() {
        ...
        // If gyro not yet permitted, request it when the user finishes tapping the card
