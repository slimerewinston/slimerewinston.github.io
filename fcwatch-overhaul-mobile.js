...
// Built: 2026-03-09T17:27:20.234Z
// =====================================================
(function() {
    'use strict';
...
(function __fcwGyroInspect() {
    ...
    // --- Config ---
    var GYRO_MAX_ROTATION = 20; // degrees
    ...
    function handleOrientation(event) {
        ...
        var deltaBeta = beta - baseBeta;
        var deltaGamma = gamma - baseGamma;
...
(function __fcwMobileCSS() {
    ...
    style.textContent = `
        ...
        @media (max-width: 768px) {
            ...
            /* Force Bootstrap columns to wrap / stack on mobile */
            .row { 
            ...
            /* Keep small utility grids intact if they explicitly ask for 6 or 4 cols */
